...
<div class="flex justify-between items-center mb-6">
    <h2 class="text-xl font-bold">Stock Out</h2>
    <a href="{{ route('stock-out.create') }}" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition">Tambah Stock Out</a>
</div>
<div class="overflow-x-auto bg-white rounded shadow">
    <table class="min-w-full divide-y divide-gray-200">
        ...
        <tbody class="bg-white divide-y divide-gray-200">
            ...
            <tr>
                <td class="px-6 py-4 whitespace-nowrap">{{ $out->id }}</td>
